...
import { getAdminEmails, getAllUserStats } from '@/lib/adminStats'
...
export async function GET(req: NextRequest) {
  ...
  // Get known users from Drive history (for names/avatars)
  ...
  const stats = await getAllUserStats(knownEmails)
