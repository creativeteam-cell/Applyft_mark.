...
export function GeneratePanel({
  ...
  // Автофетч — когда вставили URL, ждём 800мс и качаем
  useEffect(() => {
      ...
      <div className="flex gap-4">
        ...
        <div className="flex flex-col gap-2" style={{ width: 160 }}>
          ...
          <div className="relative">
            ...
            />
            {urlLoading && (
              <span className="absolute right-2 top-1/2 -translate-y-1/2 text-xs text-gray-400 animate-spin">⟳</span>
            )}
            {urlError && (
